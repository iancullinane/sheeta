...
func (m *Msngr) SendSuccessToUser(s *discordgo.Session, channelID string, content string) {
...
func (m *Msngr) SendErrorToUser(s *discordgo.Session, err error, channelID string, content string) {
